	...
	<table>
		<tr>
			<td width='450' align="center" valign='top'>
				<img class="img-logo" src="<?php echo base_url("assets/images")."/2.png"; ?>" width="150" height="100" />
				<div class='header-pt'>PT. Global Kartu Indonesia</div>
				<div class='header-address'> Komplek Ruko Mangga Dua Blok A9-2</div>
				<div class='header-address'>Jl. Jagir Wonokromo No. 100</div>
				<div class='header-address'>Surabaya Jawa Timur 60244</div>
			</td>
			<td valign='top'>
		...
		<tr>
			<td rowspan="2">
				...
				<div class="mb10">Harap diterima dengan baik barang-barang tersebut dibawah ini :</div>
			</td>
		<tr>
	</table>
